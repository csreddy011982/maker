...
import com.dvtech.maker.karithiak.MockBLServiceUtil;
...
public class MockAdviceDataFeedServicek {
   ...
   // private final MockBLServiceUtil mockBLServiceUtil;
    ...
    private void generateFile(String adviceFeedName) {
        try {
            ...
            //mockBLServiceUtil.upload(adviceFeedName, writer.toString(), remoteFileLocation);
